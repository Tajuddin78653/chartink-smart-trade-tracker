-- ============================================================
-- Chartink Smart Trade Tracker — PostgreSQL Schema
-- ============================================================
...
-- ── Alerts (raw Chartink webhook payloads) ─────────────────
...
VALUES ('admin', 'admin@chartink-tracker.com', '$2b$10$placeholder_change_me', 'admin')
ON CONFLICT DO NOTHING;
